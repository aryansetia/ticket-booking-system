...
def add_train():
    ...
    departure_time = data.get('departure_time')  # Add departure time field
    capacity = data.get('capacity')
    tatkal_seats = capacity // 10
    available_seats = capacity - tatkal_seats
...
def book_tatkal_ticket():
    ...
    if is_tatkal_booking_window_open(train.departure_time):
        ...
        return jsonify({'message': 'Tatkal booking window is closed'}), 400
